...
namespace Developurr.Orderly.Application.UnitTests.UseCase.Customer.DeleteCustomer;
...
public sealed class DeleteCustomerTest
{
    ...
    public void GivenValidInput_WhenInstantiatingDeleteCustomerUseCase_ThenShouldInstantiateDeleteCustomerUseCase()
    {
        ...
        // Act
        var deleteCustomerUseCase = new DeleteCustomerUseCase(unitOfWorkMock.Object, customerRepositoryMock.Object);
    ...
    public async void GivenValidInput_WhenCallExecute_ThenShouldCallGetByIdAsync()
    {
        ...
        // Assert
        customerRepositoryMock.Verify(x => x.GetByIdAsync(input.CustomerId, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async void GivenValidInput_WhenCallExecute_ThenShouldCallUpdateAsync()
    {
        ...
        // Assert
        customerRepositoryMock.Verify(x => x.UpdateAsync(customer, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async void GivenValidInput_WhenCallExecute_ThenShouldNotCallUpdateAsync()
    {
        ...
        // Assert
        customerRepositoryMock.Verify(x => x.UpdateAsync(customer, It.IsAny<CancellationToken>()), Times.Never);
    }
