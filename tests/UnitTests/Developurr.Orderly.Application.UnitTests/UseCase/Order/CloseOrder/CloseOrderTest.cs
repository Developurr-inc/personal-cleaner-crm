...
namespace Developurr.Orderly.Application.UnitTests.UseCase.Order.CloseOrder;
...
public sealed class CloseOrderTest
{
    ...
    public void GivenValidInput_WhenInstantiatingCloseOrderUseCase_ThenShouldInstantiateCloseOrderUseCase()
    {
        ...
        // Act
        var closeOrderUseCase = new CloseOrderUseCase(unitOfWorkMock.Object, orderRepositoryMock.Object);
    ...
    public async void GivenInvalidInput_WhenCallingExecute_ThenShouldNotCallUpdateAsync()
    {
        ...
        // Assert
       orderRepositoryMock.Verify(x => x.UpdateAsync(order, It.IsAny<CancellationToken>()), Times.Never);
    }
}