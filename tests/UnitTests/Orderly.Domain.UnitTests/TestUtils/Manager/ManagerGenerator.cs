...
public sealed class ManagerGenerator : BaseGenerator
{
    public static IEnumerable<object[]> CreateManagers()
    {
        for (var i = 0; i < Rounds; ++i)
            yield return new object[] { ManagerFixture.CreateManager() };
    }
    ...
    public static IEnumerable<object[]> CreateInvalidNames()
    {
        for (var i = 0; i < Rounds; ++i)
        {
            ...
            yield return new object[] { ManagerFixture.CreateShortName() };
            yield return new object[] { ManagerFixture.CreateLongName() };
        }
    }
}
