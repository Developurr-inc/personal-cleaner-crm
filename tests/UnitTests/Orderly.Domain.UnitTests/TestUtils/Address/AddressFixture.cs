...
public sealed class AddressFixture : BaseFixture
{
    ...
    public static string CreateShortStreet()
    {
        return StringFixture.CreateString(
            1,
            AddressValidator.StreetMinLength - 1
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.StreetMaxLength + 1,
            1_000
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.ComplementMaxLength + 1,
            1_000
        );
    }
    ...
    public static string CreateShortZipCode()
    {
        return StringFixture.CreateString(
            1,
            AddressValidator.ZipCodeMinLength - 1
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.ZipCodeMaxLength + 1,
            1_000
        );
    }
    ...
    public static string CreateShortNeighborhood()
    {
        return StringFixture.CreateString(
            1,
            AddressValidator.NeighborhoodMinLength - 1
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.NeighborhoodMaxLength + 1,
            1_000
        );
    }
    ...
    public static string CreateShortCity()
    {
        return StringFixture.CreateString(
            1,
            AddressValidator.CityMinLength - 1
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.CityMaxLength + 1,
            1_000
        );
    }
    ...
    public static string CreateShortState()
    {
        return StringFixture.CreateString(
            1,
            AddressValidator.StateMinLength - 1
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.StateMaxLength + 1,
            1_000
        );
    }
    ...
    public static string CreateShortCountry()
    {
        return StringFixture.CreateString(
            1,
            AddressValidator.CountryMinLength - 1
        );
    }
    ...
    {
        return StringFixture.CreateString(
            AddressValidator.CountryMaxLength + 1,
            1_000
        );
    }
}